...
// Al-middle (fluid)
// points
Point(3001) = {X0-Lx_AlS/2+gx_AlF,        Y0-Ly_AlF/2, Z0_AlF,        cl_AlF};
Point(3002) = {X0-Lx_AlS/2+gx_AlF+Lx_AlF, Y0-Ly_AlF/2, Z0_AlF,        cl_AlF};
Point(3003) = {X0-Lx_AlS/2+gx_AlF+Lx_AlF, Y0+Ly_AlF/2, Z0_AlF,        cl_AlF};
Point(3004) = {X0-Lx_AlS/2+gx_AlF,        Y0+Ly_AlF/2, Z0_AlF,        cl_AlF};
Point(3005) = {X0-Lx_AlS/2+gx_AlF,        Y0-Ly_AlF/2, Z0_AlF+Lz_AlF, cl_AlF};
Point(3006) = {X0-Lx_AlS/2+gx_AlF+Lx_AlF, Y0-Ly_AlF/2, Z0_AlF+Lz_AlF, cl_AlF};
Point(3007) = {X0-Lx_AlS/2+gx_AlF+Lx_AlF, Y0+Ly_AlF/2, Z0_AlF+Lz_AlF, cl_AlF};
Point(3008) = {X0-Lx_AlS/2+gx_AlF,        Y0+Ly_AlF/2, Z0_AlF+Lz_AlF, cl_AlF};
