...
Problem.Mesh = {}
Problem.Mesh.alpha = 10.5
Problem.Mesh.omega = 0.8
Problem.Mesh.gamma = 0.3
Problem.Mesh.hchar = 0.75
...
Problem.Mesh.mshFile = 'geometryF_reducedAlF.msh'
...
--     local hmin = 0.50
--     local hmax = 1.00
--     local Tr   = 333.5 -- 933.5
--     local Trn  = Tr - 5 -- 40
--     local Trp  = Tr + 20 -- 40
--     local T0   = Trn - 10
--     local Tmax = Trp + 20
-- 
--     local hL = (hmax - hmin)/(T0 - Trn) * (T - Trn) + hmin
--     local hR = (hmax - hmin)/(Tmax - Trp) * (T - Trp) + hmin
--     local hm = math.max(hmin, hL, hR)
--     local hf = math.min(hm,hmax)
-- 
-- 	return hf
-- 
-- end
