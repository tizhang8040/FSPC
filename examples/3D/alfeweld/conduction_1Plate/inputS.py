...
def getMetafor(parm):
    ...
    idMatCI = 1000		#   
    #geo ------------------------
    L = 110.0			#   solid domain length
    HF = 3.0			#   fluid domain height
    HS = 1.5			#   solid domain height
    W = 80.0			#   solid domain width
    ...
    # Imports the mesh
    if meshType == tetra:
        mshFile = os.path.join(os.path.dirname(__file__),'geometryS_tetra.msh')
    elif meshType == hexa:
        mshFile = os.path.join(os.path.dirname(__file__),'geometryS_hexa.msh')
