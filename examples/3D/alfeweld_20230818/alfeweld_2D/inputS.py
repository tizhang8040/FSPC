...
def getMetafor(input):
    ...
    T_Tool = 1075.0                     #   Temperature of the tool 
    setSN_CI = False                    #   
    #time step manager ------------------   
...
#   ----------------------------------
    ...
    initcondset.define(groups['Solid_1'],w.Field1D(w.TO,w.AB),300)
    initcondset.define(groups['Solid_2'],w.Field1D(w.TO,w.AB),300)
    initcondset.define(groups['Solid_3'],w.Field1D(w.TO,w.AB),300)
