...
Point(1008) = {X0+Lx_FeBot/2-gx_AlF, Y0-Ly_AlF/2, Z0_FeBot, clMidy_FeBot};
Point(1009) = {X0-Lx_FeBot/2+gx_AlF, Y0,          Z0_FeBot, clInt_FeBot};
Point(1010) = {X0+Lx_FeBot/2-gx_AlF, Y0,          Z0_FeBot, clInt_FeBot};
Point(1011) = {X0-Lx_FeBot/2+gx_AlF, Y0+Ly_AlF/2, Z0_FeBot, clMidy_FeBot};
Point(1012) = {X0+Lx_FeBot/2-gx_AlF, Y0+Ly_AlF/2, Z0_FeBot, clMidy_FeBot};
...
Curve Loop(1002) = {1011, 1012, 1003, 1014, 1015, 1016, 1007, 1018};
Curve Loop(1003) = {1005, 1006, 1021, 1004};
Curve Loop(1004) = {1015, 1016, 1021, 1014};

// surfaces
For k In {1001:1004:1}
   Plane Surface(k) = {k};
EndFor
...
Point(2008) = {X0+Lx_AlS/2-gx_AlF, Y0-Ly_AlF/2, Z0_AlS, clMidy_AlS};
Point(2009) = {X0-Lx_AlS/2+gx_AlF, Y0,          Z0_AlS, clInt_AlS};
Point(2010) = {X0+Lx_AlS/2-gx_AlF, Y0,          Z0_AlS, clInt_AlS};
Point(2011) = {X0-Lx_AlS/2+gx_AlF, Y0+Ly_AlF/2, Z0_AlS, clMidy_AlS};
Point(2012) = {X0+Lx_AlS/2-gx_AlF, Y0+Ly_AlF/2, Z0_AlS, clMidy_AlS};
...
Point(4003) = {X0-Lx_FeTop/2, Y0,             Z0_FeTop, clInt_FeTop};
Point(4004) = {X0+Lx_FeTop/2, Y0,             Z0_FeTop, clInt_FeTop};
...
Point(4008) = {X0+Lx_FeTop/2-gx_AlF, Y0-Ly1_FeTop/2, Z0_FeTop, clInt_FeTop};
Point(4009) = {X0-Lx_FeTop/2+gx_AlF, Y0,             Z0_FeTop, clInt_FeTop};
Point(4010) = {X0+Lx_FeTop/2-gx_AlF, Y0,             Z0_FeTop, clInt_FeTop};
Point(4011) = {X0-Lx_FeTop/2+gx_AlF, Y0+Ly1_FeTop/2, Z0_FeTop, clInt_FeTop};
Point(4012) = {X0+Lx_FeTop/2-gx_AlF, Y0+Ly1_FeTop/2, Z0_FeTop, clInt_FeTop};
...
Physical Surface("FeBot_DownCentral") = {1003,1004};
Physical Surface("FeBot_Up") = {FeBot_1[0],FeBot_2[0],FeBot_3[0],FeBot_4[0]};
