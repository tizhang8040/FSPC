...
export SCRIPT=${PWD}/examples/3D/pureCond_3Plates/reducedAlF/main_reducedAlF_stick.py

# Clean output folder

rm -rf workspace_reducedAlF_stick
mkdir workspace_reducedAlF_stick
cd workspace_reducedAlF_stick
